          ...
          <form name="sentMessage" id="contactForm" novalidate>
            <div class="control-group form-group">
              <div class="controls">
                ...
                <input type="text" class="form-control" name="full_name" id="full_name" required data-validation-required-message="Please enter your name.">
            ...
            <button type="button" class="btn btn-primary" onclick="performStore()" id="sendMessageButton">Send Message</button>
          </form>
        </div>
